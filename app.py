...
##########################################
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:CoreSocial94!@localhost:5433/tapcard'
...
def create_account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        new_transaction = Transaction('deposit','account opening',new_account.id,balance) ###OFURE this balance becomes amount in the transaction
